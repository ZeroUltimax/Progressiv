...
export interface IEmitter<M extends EventMap = any> {
  on<E extends keyof M>(event: E, cb: (...args: M[E]) => void): this;
  off<E extends keyof M>(event: E, cb: (...args: M[E]) => void): this;
  emit<E extends keyof M>(event: E, ...args: M[E]): this;
}

export class Emitter<M extends EventMap = any> implements IEmitter<M> {
